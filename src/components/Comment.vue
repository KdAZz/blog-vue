<template>
  <div>
    ...
    <div v-for="(item,i) in comment" :key="i" class="author-title reply-father">
      ...
      <div class="icon-btn">
        <span @click="showReplyInput(i,item.name,item.id)"><i class="iconfont el-icon-s-comment"></i>{{item.childBlogComments.length}}</span>
...
<script>
import {getBlogComment} from "@/api/blog/blogApi";
